  ...
  return (
    <div className="relative py-12 px-0 md:px-20">
      ...
      <div className="flex flex-col items-center text-center pt-8 pb-16 relative">
        ...
        <ImageTitle image="/Pricing.svg" title="Choose Your Perfect Plan" description="Find the right solution tailored to your company’s compensation needs and goals."/>
