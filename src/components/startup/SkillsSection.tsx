          ...
          <div className="flex items-start w-full md:w-1/2">
            ...
            <div className="flex flex-col space-y-6">
              ...
              <p className="text-[#7B7E85] text-lg max-w-xl">
                A fully digitalized offering customizable workflows, automatic
                notifications and easy integration. Perfect for companies
                seeking to optimize 360-degree assessments for skill and
