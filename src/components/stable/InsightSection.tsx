    ...
    <section className="relative pb-12 w-full bg-white ">
      <div className="container mx-auto text-center z-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center items-start mt-10 md:mx-28 flex-wrap md:flex-nowrap">
          ...
          <div
            ...
            <div className="shadow-lg bg-white rounded-xl p-6 text-left h-max">
              ...
              <p>Comprehensive solutions for <br />skilling, scaling, and talent development. </p>
          ...
          <div
            ...
            <div className="shadow-lg bg-white rounded-xl p-6 text-left h-max">
              ...
              <p>Proprietary digital tools: 360° assessments, success profiles, and hyper-personalized talent readiness journeys.</p>
            </div>
          </div>
          <div
            className="w-full md:w-1/3 relative p-6 rounded-xl flex flex-col justify-start"
            ...
            <div className="shadow-lg bg-white rounded-xl p-6 text-left h-max">
              ...
              <p>Customizable interventions underpinned by iTRAS ( intelligent Talent Readiness Acceleration System - our proprietary real-world leadership experience, action research, cutting-edge talent  methodologies).</p>
            </div>
          </div>
        ...
        <div
            ...
            data-aos-duration="500">
            {/* Nested grid inside the first card */}
            <div className="flex items-center shadow-lg gap-x-4 bg-purple-800 text-white rounded-xl p-6 text-left h-max">
