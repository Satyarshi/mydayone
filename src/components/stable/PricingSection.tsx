    ...
    <div className="flex flex-col items-center text-center md:w-11/12 w-full px-4 pb-10 mx-auto bg-[#fbfbfc]">
      ...
      <div className="flex flex-col items-center text-center pt-8 pb-16 relative">
        <ImageTitle
          ...
          description="Find the right solution hyper personalised to your company’s talent needs and goals."
        />
        ...
        <Link
          href="/form#service-form  "
          className="mt-8 px-6 py-3 bg-purple-600 text-white  rounded-lg shadow-md hover:bg-purple-700 transition duration-300"
        >
          Let's Get Ahead
        </Link>
      </div>
