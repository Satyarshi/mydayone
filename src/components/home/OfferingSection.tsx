    ...
    >
      <div className="flex flex-col items-center justify-center p-4">
        <div className=" text-center pt-15">
          <ImageTitle image="/Offerings.svg" title="Primary Areas We Excel in to Serve You" description=""/>
          ...
          {/* Tab Content */}
          <p className="text-center text-[#7B7E85] max-w-3xl mx-auto mb-8 text-base sm:text-lg">
